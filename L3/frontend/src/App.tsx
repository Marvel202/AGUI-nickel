...
import { IncomeStatement, IncomeStatementProps } from "@/components/income-statement";
...
export default function App() {
  ...
  useComponent({
    ...
    description: "Controlled Generative UI that displays a monthly profit and loss statement with a summary chart. Use this for P&L, income statement, and profit and loss requests. Prefer this tool instead of markdown tables, freeform charts, or image-based summaries.",
    parameters: IncomeStatementProps,
